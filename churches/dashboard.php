        ...
        <div id="sidebar" class="sidebar w-64 border-r border-gray-200">
            ...
            <nav class="px-2 py-4">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="members.php" class="flex items-center p-2 rounded hover:bg-sidebar-accent">
                    ...
                    <li>
                        <a href="donations.php" class="flex items-center p-2 rounded hover:bg-sidebar-accent">
                            <i class="fas fa-money-bill-alt"></i>
                            <span class="ml-3">Donations</span>
                        </a>
                    </li>
                    <li>
                        <a href="contact.php" class="flex items-center p-2 rounded hover:bg-sidebar-accent">
                            <i class="fas fa-comments"></i>
                            <span class="ml-3">Communications</span>
                        </a>
                    </li>
                    <li>
                        <a href="resources.php" class="flex items-center p-2 rounded hover:bg-sidebar-accent">
                ...
                <div id="stats-container" class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
                    ...
                    <div class="card stats-card p-4">
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            <?php echo ($members['new_this_month'] ?? '2') . ' new this month'; ?>
                        </p>
                    </div>
                    ...
                    <div class="card stats-card p-4">
                        ...
                        <div class="text-2xl font-bold">ksh<?php echo number_format($donations['current_month'] ?? 12580); ?></div>
                        <p class="text-xs text-gray-500 mt-1">
                            Last month: ksh<?php echo number_format($donations['last_month'] ?? 10890); ?>
                        </p>
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <?php else: ?>
                                <div class="flex items-center justify-between border-b pb-3">
                                    <div>
                                        <p class="font-medium">Sunday Service</p>
                                        <p class="text-sm text-gray-500">Mar 31, 9:00 AM</p>
                                    </div>
                                    <div class="text-sm text-right">
                                        <p>Main Sanctuary</p>
                                    </div>
                                ...
                                <div class="flex items-center justify-between border-b pb-3">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Apr 1, 6:00 PM</p>
                                    </div>
                                    <div class="text-sm text-right">
                                        <p>Choir Room</p>
                                    </div>
                                ...
                                <div class="flex items-center justify-between border-b pb-3">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Apr 20, 7:00 PM</p>
                                    </div>
                                    <div class="text-sm text-right">
                                        <p>Fellowship Hall</p>
                                    </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Apr 24, 10:00 PM</p>
                                    </div>
                                    <div class="text-sm text-right">
                                        <p>Main Sanctuary</p>
                                    </div>
